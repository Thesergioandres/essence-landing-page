...
async function main() {
  ...
  const sales = await Sale.find({ employee: user._id })
    .sort({ saleDate: -1, createdAt: -1 })
    .limit(LIMIT)
    .populate("product", "name clientPrice suggestedPrice employeePrice")
    .populate("promotion", "name employeePrice promotionPrice")
    .lean();
  ...
  for (const sale of sales) {
    console.log({
      ...
      employeePrice: sale.employeePrice,
      employeeProfitPercentage: sale.employeeProfitPercentage,
      ...
      promotion: sale.promotion
        ? {
            ...
            employeePrice: sale.promotion.employeePrice,
      ...
      product: sale.product
        ? {
            ...
            employeePrice: sale.product.employeePrice,
