...
export class AnalyticsRepository {
  ...
  async getEstimatedProfit(businessId) {
    ...
    const scenarioMessages = {
      ...
      B: "Ganancia estimada: almacén + inventario de empleados",
      C: "Ganancia estimada: almacén + sucursales",
      D: "Ganancia estimada: almacén + sucursales + empleados",
    };
   ...
   * Calcula la ganancia estimada del empleado basándose en su INVENTARIO ACTUAL
