...
describe("Sale Model - Cálculo de ganancias", () => {
  ...
  test("Debe calcular correctamente ganancia de empleado normal (20%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia de empleado 1er lugar (25%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia de empleado 2do lugar (23%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia de empleado 3er lugar (21%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia admin con empleado normal (20%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia admin con empleado 1er lugar (25%)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente ganancia total (empleado + admin)", async () => {
    const sale = await Sale.create({
      employee: employee._id,
      product: product._id,
      quantity: 10,
  ...
  test("Debe calcular correctamente venta directa de admin (sin empleado)", async () => {
    const sale = await Sale.create({
      employee: null,
      product: product._id,
      quantity: 10,
