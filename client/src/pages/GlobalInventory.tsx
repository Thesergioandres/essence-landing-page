      ...
      if (res.success) {
        ...
        const mappedInventory: GlobalInventoryItem[] = res.inventory.map(
          (item: any) => {
            ...
            // Unassigned = "Ghost" units (System says X, Reality is Y < X, so X-Y is Unassigned)
            // If System says 10, Reality is 8. Unassigned = 2.
            // If System says 8, Reality is 10. Unassigned = -2 (Surplus).
