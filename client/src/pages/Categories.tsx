    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 font-semibold text-white transition hover:from-purple-700 hover:to-pink-700"
        >
          + Nueva categoría
        </button>
      </div>
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 rounded-lg border border-gray-600 px-4 py-2 text-sm font-medium text-white transition hover:border-purple-500 hover:bg-purple-500/10"
                >
                  Editar
                </button>
                <button
                  onClick={() => handleDelete(category._id, category.name)}
                  className="flex-1 rounded-lg border border-red-600 px-4 py-2 text-sm font-medium text-red-400 transition hover:bg-red-500/10"
                >
                  Eliminar
                </button>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 rounded-lg border border-gray-700 px-4 py-3 font-semibold text-gray-300 transition hover:border-purple-500 hover:text-white"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="flex-1 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-4 py-3 font-semibold text-white transition hover:from-purple-700 hover:to-pink-700"
                >
