...
export default function SpecialSales() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-linear-to-br relative overflow-hidden rounded-2xl border border-purple-500/20 from-purple-900/50 via-pink-900/30 to-purple-900/50 p-6 sm:p-8">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>

        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-4">
            <div className="bg-linear-to-br rounded-xl from-purple-500 to-pink-500 p-3 shadow-lg shadow-purple-500/50">
              <svg
          ...
          <button
            ...
            className="bg-linear-to-r group relative flex min-h-12 items-center justify-center gap-2 overflow-hidden rounded-xl from-purple-600 to-pink-600 px-6 py-3 font-semibold text-white transition-all hover:scale-105 hover:shadow-lg hover:shadow-purple-500/50"
          >
            <div className="bg-linear-to-r absolute inset-0 from-purple-700 to-pink-700 opacity-0 transition-opacity group-hover:opacity-100"></div>
            <svg
      ...
      {stats && (
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="bg-linear-to-br group relative overflow-hidden rounded-xl border border-gray-700 from-gray-800/80 to-gray-900/80 p-5 transition-all hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/20">
          ...
          <div className="bg-linear-to-br group relative overflow-hidden rounded-xl border border-gray-700 from-gray-800/80 to-gray-900/80 p-5 transition-all hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/20">
          ...
          <div className="bg-linear-to-br group relative overflow-hidden rounded-xl border border-gray-700 from-gray-800/80 to-gray-900/80 p-5 transition-all hover:border-green-500/50 hover:shadow-lg hover:shadow-green-500/20">
          ...
          <div className="bg-linear-to-br group relative overflow-hidden rounded-xl border border-gray-700 from-gray-800/80 to-gray-900/80 p-5 transition-all hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/20">
      ...
      {/* Filtros mejorados */}
      <div className="bg-linear-to-br rounded-xl border border-gray-700 from-gray-800/50 to-gray-900/50 p-5 backdrop-blur-sm">
      ...
      {/* Tabla mejorada */}
      <div className="bg-linear-to-br overflow-hidden rounded-xl border border-gray-700 from-gray-800/50 to-gray-900/50 backdrop-blur-sm">
        {loading ? (
          <div className="flex min-h-[400px] items-center justify-center">
            <LoadingSpinner size="lg" message="Cargando ventas especiales..." />
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-linear-to-r border-b border-gray-700 from-purple-900/30 to-pink-900/30">
                <tr>
      ...
      {/* Paginación mejorada */}
      {totalPages > 1 && (
        <div className="bg-linear-to-br flex items-center justify-between rounded-xl border border-gray-700 from-gray-800/50 to-gray-900/50 p-4 backdrop-blur-sm">
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="bg-linear-to-r flex h-9 min-w-9 items-center justify-center rounded-lg from-purple-600 to-pink-600 px-3 text-sm font-bold text-white">
              {currentPage}
            </span>
