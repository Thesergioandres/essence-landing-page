    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 max-w-3xl text-sm text-gray-400">
          ...
          Cambios aqui afectan el desempeño de empleados en tiempo real.
        </p>
      </div>
      ...
      <div className="mb-6 rounded-xl border border-teal-500/40 bg-teal-900/20 p-6">
        <h2 className="text-2xl font-semibold text-white">
          Comision Base del Empleado
        </h2>
        <p className="mt-2 text-sm text-teal-100/80">
          Este porcentaje define la ganancia base del empleado y afecta el
      ...
      <div className="mb-6 rounded-xl border border-gray-800 bg-gray-900/80 p-6">
        ...
        <p className="mt-2 text-sm text-gray-400">
          Premia a los mejores empleados del periodo.
        </p>
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          <div>
            ...
            >
              ...
              <option value="commission">Comision del empleado</option>
            </select>
            <p className="mt-1 text-xs text-gray-400">
      ...
      <div className="mb-6 rounded-xl border border-gray-800 bg-gray-900/80 p-6">
        ...
        <p className="mt-2 text-sm text-gray-400">
          Define como crecen los empleados y que beneficios obtienen.
        </p>
        ...
        {levels.map((level, index) => (
          ...
          >
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">
                Se suma a la comision base del empleado.
              </p>
            </div>
            <div>
              <label className="mb-1 block text-sm text-gray-300">
        ...
        {salesTargets.map((target, index) => (
          ...
          >
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">
                Icono que se muestra al empleado.
              </p>
            </div>
