...
- Control de mercancia en bodega, sedes y empleados.
...
| Empleado | Ventas, catalogo y logistica asignada | Puede operar sin acceso a costos sensibles |
...
## Modo operativo empleado

Si un empleado entra por una ruta administrativa, la plataforma lo dirige automaticamente a su ruta operativa equivalente.
`,
  },
  {
    id: "04-mapa-rutas",
...
`,
  ...
  {
    id: "05-catalogo",
    title: "Catalogo Publico Y Empleado",
    subtitle:
      "Venta asistida con filtros, enlaces compartibles y PDF comercial.",
    audience: "Admin, empleado, equipo comercial",
    readingTime: "9 min",
...
- Muestra solo los productos que el empleado puede ofrecer.
- Incluye filtros de precio, categoria y disponibilidad.
- Cada empleado puede compartir su enlace publico individual.
...
No confirmar ventas con stock incierto. La consistencia de bodega, sedes y empleados depende de mantener entradas y salidas sincronizadas.
`,
  },
  {
    ...
    audience: "Admin, empleado operativo",
    readingTime: "9 min",
...
- Permite asignar mercancia a empleados y tambien retirarla cuando corresponde.
...
## Transferencias empleado

- El empleado puede trasladar mercancia a otro empleado autorizado.
...
`,
  },
  {
    ...
    audience: "Admin logistica y empleado",
    readingTime: "9 min",
...
- Muestra avance comercial del empleado con metas y reconocimientos.
...
`,
  },
  {
    ...
    audience: "Admin y empleado comercial",
    readingTime: "11 min",
...
`,
  },
  {
    ...
    audience: "Admin, empleado autorizado",
    readingTime: "8 min",
...
- Permite retirar mercancia desde bodega, sede o empleado.
...
- Entrega reporte maestro con ventas, inventario, gastos y empleados.
...
`,
  },
  {
    ...
    audience: "Direccion comercial y empleados",
    readingTime: "7 min",
...
- Podio visual y tabla completa por empleado.
...
Si un empleado tiene comision fija activa, la jerarquia de comision fija domina sobre bonus de gamificacion.
`,
  },
  {
    id: "16-god-saas",
...
- Limites personalizados de sedes y empleados.
...
`,
  },
  {
    ...
    checkpoints: [
      ...
      "Respetar la comision fija cuando este definida para un empleado.",
...
1. Si un empleado tiene comision fija, ese porcentaje manda.
