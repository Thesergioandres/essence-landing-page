    ...
    const loadData = async () => {
      try {
        ...
        try {
          ...
          console.error("âŒ Error loading config:", e);
        }
        ...
        try {
          ...
          console.error("âŒ Error loading stats:", e);
        }
        ...
        try {
          ...
          console.error("âŒ Error loading ranking:", e);
        }
        ...
        try {
          ...
          console.error("âŒ Error loading commission:", e);
        }

        if (!isActive) return;

        console.warn("[Essence Debug]", "âœ… Datos cargados exitosamente (parcial o total)");
        ...
        console.error(
          "âŒ CRITICAL ERROR rendering employee level page:",
          error
        );
      } finally {
        if (isActive) {
          console.warn("[Essence Debug]", "ðŸ›‘ Finalizando estado de carga");
          setLoading(false);
        }
      }
    };
