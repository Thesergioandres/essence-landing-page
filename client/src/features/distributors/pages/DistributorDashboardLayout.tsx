...
export default function DistributorDashboardLayout() {
  ...
  return (
    <div className="bg-app-distributor-shell max-w-screen h-screen overflow-hidden overflow-x-hidden bg-[radial-gradient(circle_at_14%_16%,rgba(14,116,144,0.2),transparent_42%),radial-gradient(circle_at_88%_14%,rgba(30,58,138,0.2),transparent_46%),linear-gradient(140deg,#04070d_0%,#090f1b_46%,#050912_100%)]">
      {/* Mobile Overlay */}
      {sidebarOpen && (
        <div
      ...
      >
        <div className="flex h-full flex-col overflow-hidden">
          ...
          >
            ...
            <NavLink
              to="/distributor/request-dispatch"
              className={({ isActive }): string => navLinkClasses(isActive)}
            >
              <svg
                className="h-5 w-5"
            ...
            {(canManageSalesFromTeam ||
              ...
              <>
                ...
                {canManageStockFromTeam && canViewInventoryFromTeam && (
                  <NavLink
                    to="/distributor/operativo/stock-management"
                ...
                {canViewInventoryFromTeam && (
                  <NavLink
                    to="/distributor/operativo/global-inventory"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewInventoryFromTeam && (
                  <NavLink
                    to="/distributor/operativo/branches"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewTransferHistoryFromTeam && (
                  <NavLink
                    to="/distributor/operativo/transfer-history"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canManageSalesFromTeam && (
                  <>
                    ...
                    <NavLink
                      to="/distributor/operativo/sales"
                      className={({ isActive }): string =>
                        navLinkClasses(isActive)
                      }
                    >
                ...
                {canViewPromotionsFromTeam && (
                  <NavLink
                    to="/distributor/operativo/promotions"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewProvidersFromTeam && (
                  <NavLink
                    to="/distributor/operativo/providers"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewCustomersFromTeam && (
                  <NavLink
                    to="/distributor/operativo/customers"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewAnalyticsFromTeam && (
                  <NavLink
                    to="/distributor/operativo/analytics"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
                ...
                {canViewExpensesFromTeam && (
                  <NavLink
                    to="/distributor/operativo/expenses"
                    className={({ isActive }): string =>
                      navLinkClasses(isActive)
                    }
                  >
