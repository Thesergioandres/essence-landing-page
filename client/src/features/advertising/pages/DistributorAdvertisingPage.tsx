/**
 * DistributorAdvertisingPage — Publicidad para distribuidores
 *
 * Dos apartados:
 * - Mis productos (stock del distribuidor)
...
export default function DistributorAdvertisingPage() {
  ...
  useEffect(() => {
    const loadMyStock = async () => {
      try {
        ...
        console.error("Error al cargar stock del distribuidor:", err);
    ...
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-6 text-gray-100">
      ...
      <div>
        <h1 className="text-2xl font-bold text-white sm:text-3xl">
          🎨 Publicidad para Distribuidores
        </h1>
