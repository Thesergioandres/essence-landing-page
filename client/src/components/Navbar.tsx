      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center" onClick={() => setMobileMenuOpen(false)}>
            <h1 className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-xl sm:text-2xl font-bold text-transparent">
              ESSENCE
            </h1>
          </Link>
          ...
          <div className="hidden items-center gap-3 lg:gap-4 md:flex">
            ...
            <Link
              ...
              className="rounded-lg border border-blue-500 bg-gradient-to-r from-blue-600 to-cyan-600 px-3 lg:px-4 py-2 text-xs lg:text-sm font-medium text-white transition hover:from-blue-700 hover:to-cyan-700"
            >
              Distribuidor
            </Link>
          </div>
        ...
        >
          <div className="space-y-1 pb-4 pt-2">
            <Link
              ...
              className="block px-4 py-3 text-base text-gray-300 transition hover:bg-purple-600/10 hover:text-purple-400 rounded-lg"
            >
              Inicio
            </Link>
            <Link
            ...
            <Link
              to="/login/distributor"
              onClick={() => setMobileMenuOpen(false)}
              className="block mx-4 px-4 py-3 text-center text-base font-medium text-white bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg transition hover:from-blue-700 hover:to-cyan-700"
            >
              Distribuidor
            </Link>
          </div>
